...
The primary purpose of this repo is to host a pipeline to copy AER FloodScan data to our **dev** Azure Blob Storage Account. **Note** and official FloodScan pipelines is under development [here](https://github.com/OCHA-DAP/ds-raster-pipelines/tree/main)
